...
/**
 * The Class FeatureExtractorStatistics.
 * @author dheeraj
 */
public class FeatureExtractorStatistics extends BaseDto{

    /** The metric any color prcnt feat non unif ol. */
    private double metricAnyColorPrcntFeatNonUnifOL;

    /** The metric derivative lr spread. */
    private double metricDerivativeLRSpread;

    /** The metric g signal2 noise. */
    private double metricGSignal2Noise;

    /** The metric g signal intensity. */
    private double metricGSignalIntensity;

    /** The metric r signal2 noise. */
    private double metricRSignal2Noise;
     ...
     */
    public double getMetricAnyColorPrcntFeatNonUnifOL() {
     ...
     */
    public void setMetricAnyColorPrcntFeatNonUnifOL(double metricAnyColorPrcntFeatNonUnifOL) {
     ...
     */
    public double getMetricDerivativeLRSpread() {
     ...
     */
    public void setMetricDerivativeLRSpread(double metricDerivativeLRSpread) {
     ...
     */
    public double getMetricGSignal2Noise() {
     ...
     */
    public void setMetricGSignal2Noise(double metricGSignal2Noise) {
     ...
     */
    public double getMetricGSignalIntensity() {
     ...
     */
    public void setMetricGSignalIntensity(double metricGSignalIntensity) {
     ...
     */
    public double getMetricRSignal2Noise() {
     ...
     */
    public void setMetricRSignal2Noise(double metricRSignal2Noise) {
     ...
     */
    public void setMetricRSignalIntensity(double metricRSignalIntensity) {
